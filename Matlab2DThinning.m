...
% extraction of 2D binary images using a real-time GPU implementation as
...
%
%  USAGE: segs = Matlab2DThinning(img, pruning_length, smoothing_span)
%
%  OUTPUT
%	segs:  Cell array of curvilinear segments. Each element of the cell
%          array is a Nx2 array containing 2D coordinates of a centerline
%          segment. Coordinates are zero based.
%
